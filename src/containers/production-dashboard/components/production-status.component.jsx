...
import ScrapParetoModal from './scrapParetoModal.component'
import DowntimeParetoModal from './downtimeParetoModal.component'
import HxHParetoModal from './hxhParetoModal.component'
...
const ProductionStatus = React.memo(({
    productionStatus
}) => {
