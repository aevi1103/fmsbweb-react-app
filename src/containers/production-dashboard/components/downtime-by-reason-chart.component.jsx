...
const DowntimeByReasonChart = React.memo(({
    data,
    height = 150,
    isModal = false,
    modalCaption = ''
    ...
    const caption = !isModal 
        ? `Top 5 Downtime Pareto by Reason`
        : modalCaption
    ...
    const dataSource = {
        ...
        linkeddata: data.map(({ label, details }) => ({
            ...
            linkedchart: {
                chart: {
                    caption: `${label} Downtime by Machine`,
                    ...chartConfig,
                    ...tooltipStyle
                },
                
                data: details.map(({ machine, downtimeLoss }) => ({
                    label: machine,
                    value: downtimeLoss
                }))
            }
...
export default DowntimeByReasonChart;